...
<div class="flex place-items-center rounded-xl bg-white px-4 py-2 my-4">
  ...
  <input bind:this={input} class="mx-2 px-1 py-2 w-1 flex-grow focus:outline-none focus:ring-1 ring-primary-500 rounded-sm" id="search-text" type="search" placeholder="some city" >
</div>
